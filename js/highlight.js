...
var hljs = function () {
  ...
  ; "object" == typeof exports && "undefined" != typeof module && (module.exports = hljs); hljs.registerLanguage("plaintext", (() => {
    "use strict"; return t => ({
    ...
    "use strict"; return e => {
      var n = {
        ...
        built_in: "int float array pair object any string",
      ...
      ; r.contains = [o, c, s, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, i, e.C_BLOCK_COMMENT_MODE],
        l.contains = [d, c, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, i, e.inherit(e.C_BLOCK_COMMENT_MODE, {
          ...
          name: "Simula", aliases: ["sim", "simula"],
          keywords: n, illegal: /::/, contains: [e.COMMENT("\'", "$", {
            ...
            className: "meta", begin: "#",
              ...
              "meta-keyword": "define undef ifdef ifndef endif err warn"
            }
          }, g, i, {
            beginKeywords: "class selector func", relevance: 0, end: /[{;=]/,
            illegal: /[^\s:,]/, contains: [{
            ...
            begin: "(" + _ + "\\s+)+" + e.IDENT_RE + "\\s*(<.+>\\s*)?\\(", returnBegin: !0,
              ...
              beginKeywords: "expose hidden def func",
              relevance: 0
            }, {
